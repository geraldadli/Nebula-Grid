...
var _move = _dir;
if (_dist < preferred_dist - 20)      _move = _dir + 180; // back off
else if (_dist <= preferred_dist + 20) _move = _dir + 90;  // strafe
...
if (shoot_cd == 0 && _dist < 420) {
    var _w = nb_make_weapon("enemy", 1, 0, 1, 4, 7, false);
    nb_fire_weapon(x, y, _dir, _w, obj_enemy_bullet, 1);
    shoot_cd = 70;
}
